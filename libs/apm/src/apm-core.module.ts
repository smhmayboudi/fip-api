...
export class ApmCoreModule {
  ...
  static forRoot(options?: ApmModuleOptions): DynamicModule {
    ...
    const apmModuleOptionsProvider: Provider<ApmModuleOptions> = {
      provide: APM_MODULE_OPTIONS,
      useValue: opts,
    };
    return {
      module: ApmCoreModule,
      providers: [apmInstanceProvider, apmModuleOptionsProvider],
    };
  }
