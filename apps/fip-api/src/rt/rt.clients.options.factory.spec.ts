...
import { RtConfigService } from "./at.config.service";
import { RtConfigServiceInterface } from "./at.config.service.interface";
import { Test } from "@nestjs/testing";

describe("RtClientsOptionsFactory", () => {
  ...
  it("should be defined", () => {
    ...
    expect(new RtClientsOptionsFactory(service)).toBeDefined();
  });

  it("createClientsOptions should be equal to an option", () => {
    expect.hasAssertions();
    expect(
      new RtClientsOptionsFactory(service).createClientsOptions()
    ).toBeDefined();
  });
