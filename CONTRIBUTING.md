...
You can file new issues by filling out our [new issue form](https://gitlab.3re.ir/fipbit/fip-api/issues/new).
...
1. Search [GitHub](https://gitlab.3re.ir/fipbit/fip-api/merge_requests) for an open or closed PR
   that relates to your submission. You don't want to duplicate effort.
1. Fork the fipbit/fip-api repo.
...
1. In GitHub, send a pull request to `fip-api:master`.
...
Samples: (even more [samples](https://gitlab.3re.ir/fipbit/fip-api/commits/master))
...
[gitlab]: https://gitlab.3re.ir/fipbit/fip-api/
